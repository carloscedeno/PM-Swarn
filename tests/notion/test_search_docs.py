...
@pytest.mark.asyncio
async def test_resolve_notion_doc_no_hit(mock_client):
    os.environ["NOTION_DOCS_DATABASE_ID"] = "test_db"
    mock_client.query_database.return_value = {"results": []}
